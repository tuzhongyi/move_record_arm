...
export interface NetworkNVRConfigMessageReceiverEvent {
  save_result(args: ResultArgs): void
}
export interface NetworkNVRConfigMessageSenderEvent {
...
export class NetworkNVRConfigMessage
  implements NetworkNVRConfigMessageSenderEvent
{
